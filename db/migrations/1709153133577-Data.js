module.exports = class Data1709153133577 {
    name = 'Data1709153133577'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "worker" ("id" character varying NOT NULL, CONSTRAINT "PK_dc8175fa0e34ce7a39e4ec73b94" PRIMARY KEY ("id"))`)
